                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Add Audio</h6>
                                </div>
                                <div class="card-body">
...
if(isset($_POST['btnadd'])){
    ...
    $check=mysqli_query($conn,"INSERT INTO `audio`(`id`, `s_name`, `s_audio`, `s_artist`, `s_singer`, `movie_name`) VALUES
     ('','$name','$audname','$artist','$singer','$movie')");
