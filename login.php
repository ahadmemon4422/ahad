                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" name="btnadd" value="Login" class="btn btn-primary btn-user btn-block">
...
if(isset($_POST['btnadd'])){
    ...
    $pass=$_POST['txtpass'];
    $q=mysqli_query($conn,"SELECT * FROM `regform` WHERE `email`='$email' AND `password`= '$pass'");
