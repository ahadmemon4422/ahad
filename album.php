                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card position-relative">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Add Album</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="txtimage" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
...
if(isset($_POST['btnadd'])){
    ...
    $check=mysqli_query($conn,"INSERT INTO `album`(`id`, `name`, `artisted`, `discription`, `coverphoto`) VALUES 
    ('','$name','$artist','$discription','$audname')
    ");
//    INSERT INTO `album`(`id`, `name`, `artisted`, `discription`, `coverphoto`) VALUES
